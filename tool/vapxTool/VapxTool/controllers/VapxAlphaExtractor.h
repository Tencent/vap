...
typedef void (^extractCompletionBlock)(NSInteger framesCount, NSArray<NSString *>* alphaFiles, NSArray<NSString *>* rgbFiles);

@interface VapxAlphaExtractor : NSObject

@property (nonatomic, strong) NSString * resourceDirectory;
